...
public class ScaledGraphics extends Graphics {
  ...
  public void drawImage(Image srcImage, int sx, int sy, int sw, int sh, int tx,
  ...
  public Rectangle getClip(Rectangle rect) {
     ...
     * ceiling of the resulting double. This is necessary because forward
     * scaling essentially performs a floor() function. Without this, figures
     * will think that they don't need to paint when actually they do.
     */
  ...
  private Rectangle zoomClipRect(Rectangle r) {
    ...
    tempRECT.width = (int) (Math.ceil(((r.x + r.width) * zoom + fractionalX)))
        - tempRECT.x;
    tempRECT.height = (int) (Math.ceil(((r.y + r.height) * zoom + fractionalY)))
        - tempRECT.y;
    return tempRECT;
  }
